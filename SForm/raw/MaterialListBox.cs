...
namespace SForm {
    ...
    public class MaterialListBox : Control, IMaterialControl {
        ...
        protected int _hoveredItem;
        protected MaterialSkin.Controls.MaterialScrollBar _scrollBar;
        ...
        private void SetDefaults() {
            ...
            _multiKeyDown = false;
            _scrollBar = new MaterialSkin.Controls.MaterialScrollBar() {
                Orientation = MaterialSkin.Controls.MaterialScrollOrientation.Vertical,
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            //Set TextAlignFlags
            TextRenderer.TextAlignFlags primaryTextAlignFlags;
            TextRenderer.TextAlignFlags secondaryTextAlignFlags = TextRenderer.TextAlignFlags.Left | TextRenderer.TextAlignFlags.Top;
            if (_style == ListBoxStyle.TwoLine || _style == ListBoxStyle.ThreeLine) {
                primaryTextAlignFlags = TextRenderer.TextAlignFlags.Left | TextRenderer.TextAlignFlags.Bottom;
            } else {
                //SingleLine
                primaryTextAlignFlags = TextRenderer.TextAlignFlags.Left | TextRenderer.TextAlignFlags.Middle;
            }
            ...
            for (int i = firstItem; i < lastItem; i++) {
                ...
                Rectangle itemRect = new Rectangle(0, (i - firstItem) * _itemHeight,
                    Width - (_showScrollBar && _scrollBar.Visible ? _scrollBar.Width : 0),
                    _itemHeight);
                ...
                Rectangle primaryTextRect = new Rectangle(itemRect.X + _leftrightPadding,
                    itemRect.Y, itemRect.Width - (2 * _leftrightPadding), itemRect.Height);
                ...
                using (TextRenderer NativeText = new TextRenderer(g)) {
                    /*
                    ...
                    */
                    ...
                    NativeText.DrawMultilineTransparentText(
                        ...
                        primaryTextRect.Location,
                        primaryTextRect.Size,
                        primaryTextAlignFlags);  //EndEllipsis
        ...
        private void InvalidateScroll(object sender, EventArgs e) {
            ...
            if (_items.Count == 0) { _scrollBar.Value = 0; }
            Invalidate();
        }
